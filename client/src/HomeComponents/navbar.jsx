...
const Navbar = () => {
  ...
  return (
    <section className="overflow-hidden bg-surface font-semibold fixed top-23 md:justify-center w-full z-20 h-12 flex border-b border-gray-300 px-6">
      {/* Desktop Menu */}
      <span className="w-full absolute bg-white/50 blur-lg shine pointer-events-none inset-y-0 " />
      <div className="hidden min-[800px]:flex md: text-text font-[1200] gap-16 h-full items-center justify-center text-lg">
        <a href="/">Home</a>
        <a href="/shop">Shop</a>
